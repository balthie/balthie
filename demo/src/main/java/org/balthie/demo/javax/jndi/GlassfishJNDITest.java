 ...
 * @author：balthie + 10050
 * @createtime ： 2015年5月26日 下午2:39:09
 * @description 测试使用glassfish jndi resource 保存系统参数
 * fish上的配置菜单: Resources/JNDI/Custom Resources/ new 
 * 
 */
public class GlassfishJNDITest
{
    ...
    public static void test2() throws NamingException
    {
        ...
        /*glassfish  domain.xml: <system-property name="IIOP_LISTENER_PORT" value="23700"></system-property>*/
