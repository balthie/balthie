...
public class PropertiesUtil
{
    ...
    public void method1(String filePath) throws IOException
    {
        ...
        Properties p = new Properties();
        p.load(is);
        System.out.println(p.getProperty("hibernate.bytecode.provider", "none"));
    }
    
    public void method2(String name)
    {
        ResourceBundle bundle  = ResourceBundle.getBundle(name, Locale.getDefault()); 
        String s = bundle.getString("hibernate.bytecode.provider");  
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        util.method1("/hibernate.properties");
        
        util.method2("hibernate");
        
        util.method3("D://luna-Workspaces//Server//src//main//resouces//hibernate.properties");
        
        util.method4("hibernate.properties");
        
        util.method5("hibernate.properties");
        
        util.method7("hibernate.properties");
    }
}
