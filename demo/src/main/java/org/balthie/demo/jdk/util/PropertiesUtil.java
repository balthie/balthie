...
public class PropertiesUtil
{
    ...
    public void method1(String filePath) throws IOException
    {
        ...
        Properties p = new Properties();
        p.load(is);
        System.out.println(p.getProperty("org.quartz.scheduler.skipUpdateCheck", "none"));
    }
    
    public void method2(String name)
    {
        ResourceBundle bundle  = ResourceBundle.getBundle(name, Locale.getDefault()); 
        String s = bundle.getString("org.quartz.scheduler.skipUpdateCheck");  
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        util.method1("/quartz/quartz.properties");
        
        util.method2("quartz/quartz");
        
        util.method3("E://balthie//github_balthie//demo//src//main//resources//quartz//quartz.properties");
        
        util.method4("quartz/quartz.properties");
        
        util.method5("quartz/quartz.properties");
        
        util.method7("quartz/quartz.properties");
    }
}
